...
Since the controller operates using Modbus RTU by default, you must  [change the transfer protocol](https://www.waveshare.com/wiki/Modbus_POE_ETH_Relay)  to Modbus_TCP protocol. Without this change, connection to the relay from the driver will  **fail**.

![thumb modbus tcp](./images//thumb_modbus_tcp.webp)
...
![main control panel](./images/thumb_main_control_panel.webp)